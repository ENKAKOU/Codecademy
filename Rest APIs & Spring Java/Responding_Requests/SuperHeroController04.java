...
public class SuperHeroController04 {

    private final SuperHeroRepository superHeroRepository;
    private final SuperReportRepository superReportRepository;

    public SuperHeroController04(SuperHeroRepository superHeroRepository,
    ...
    public String createNewSuperHero() {
    ...
    public String postHelp(@RequestParam String postalCode,
                           @RequestParam String streeAddress) {
