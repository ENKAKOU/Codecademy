...
public class Main{
    ...
    public static void main(String[] args){
        ...
        String mike = "Mike's " + mikesChocolateBar.getName() +
                " chocolate bar costs " + mikesChocolateBar.getPrice();
        String gabby =  "Gabby's " + gabbysBagOfChips.getName() +
                " bag of chips costs " + gabbysBagOfChips.getPrice();
