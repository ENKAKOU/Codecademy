...
public class SuperHeroController09 {

    private final SuperHeroRepository superHeroRepository;
    private final SuperReportRepository superReportRepository;

    public SuperHeroController09(SuperHeroRepository superHeroRepository,
    ...
    public Iterable<SuperReport> getHeroReportByPostal(@PathVariable String postalCode) {
        ...
        if (counter < 1) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND,
                    "Report Not Found. Please try a different postal code.");
        }
